# CMMC Scoping Guide – Level 2, Version 2.13 (September 2024) — full text

Source: dodcio.defense.gov, DoD-CIO-00006 (ZRIN 0790-ZA22). Implements 32 CFR § 170.19. This is version 2.13 — check dodcio.defense.gov/CMMC for a newer version before relying on this for a live engagement if it has been a while since this file was last refreshed.

This is the authoritative, complete text: the five asset categories and Table 1, ESP rules and Table 2, separation, enclaves, SPD, use cases. Quote directly from it.
